...
- **Informations pratiques** (horaires, itinéraire, dress code, idées cadeaux)
- **RSVP & Confirmation de présence**
- **Partage et galerie de photos des invités**
- **Espace organisateurs** sécurisé avec téléchargement groupé (.zip) des photos
